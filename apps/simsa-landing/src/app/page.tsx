            ...
            {t.creates.outputs.map((output, i) => (
              <div className="feat" key={output}>
                ...
                <div className={`feat-media fm-${i % 4}`} aria-hidden>
                  {i % 4 === 0 && (
                    <img className="feat-shot fs-plan" src="/shots/shot-overview.png" alt="" loading="lazy" />
                  )}
                  {i % 4 === 1 && (
                    <img className="feat-shot fs-evidence" src="/shots/shot-items.png" alt="" loading="lazy" />
                  )}
                  {i % 4 === 2 && (
                    <img className="feat-shot fs-decision" src="/shots/shot-overview.png" alt="" loading="lazy" />
                  )}
                  {i % 4 === 3 && (
                    <img className="feat-shot fs-pack" src="/shots/shot-export.png" alt="" loading="lazy" />
                  )}
                </div>
              </div>
            ))}
