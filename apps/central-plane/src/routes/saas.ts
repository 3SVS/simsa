      ...
      return c.json(
        {
          ...
          byo_setup_url: "https://github.com/3SVS/simsa#byo",
        },
        402,
      );
    }
...
function renderResultComment(args: {
  ...
  if (args.error) {
    return [
      ...
      ``,
      `Try pushing again. If it keeps happening, this is on us — please [open an issue](https://github.com/3SVS/simsa/issues/new).`,
    ].join("\n");
  }
