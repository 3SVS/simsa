...
/** Resolve the bundled legacy catalog path (ships inside @simsa/core). */
function resolveBundledCatalog(): string {
  // When bundled via tsc, this file lives at node_modules/@simsa/cli/dist/commands/seed.js.
  // The catalog ships under node_modules/@simsa/core/dist/memory/seeds/solo-cto-agent-failure-catalog.json
